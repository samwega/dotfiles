...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- awful.tag({ "L", "e", "x", "l", "e", "g", "i", "o", "n" }, s, awful.layout.layouts[1])
    awful.tag({ "A", "l", "e", "x", "a", "n", "d", "e", "r" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey}, "e", function () awful.util.spawn("pcmanfm") end,
              {description = "launch pcmanfm", group = "pcmanfm"}),

                  awful.key({ modkey,           }, "Delete", function () awful.util.spawn("mate-system-monitor") end,
              {description = "launch system monitor", group = "mate-system-monitor"}),
    ...
    -- Standard program
    awful.key({ modkey}, "space", function () awful.spawn("alacritty --class Alacritty-slave") end),
...
--	awful.util.spawn("dmenu_run") end,
	...
	awful.util.spawn("rofi -combi-modi window,drun -show combi -modi combi") end,
           {description = "rofi run", group = "launcher"}),
...
awful.util.spawn("dmenu_run") end,
    ...
    -- prompt rofi natural calculator (qalc)
    awful.key({ modkey },            "q",     function ()
	awful.util.spawn("rofi -show calc -modi calc -no-show-match -no-sort") end,
           {description = "run_rofi qalc", group = "launcher"}),
...
awful.rules.rules = {
    ...
    { rule = { instance = "Alacritty-slave"}, callback = function(c)
    awful.client.setslave(c) end },
    { rule = { instance = "pcmanfm"}, callback = function(c)
    awful.client.setslave(c) end },
    { rule = { instance = "subl"}, callback = function(c)
    awful.client.setslave(c) end },
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false, titlebars_height = 1 }
    },
...
--         top_titlebar = awful.titlebar(c, height),
--         layout = wibox.layout.align.horizontal
--     }
-- end)
